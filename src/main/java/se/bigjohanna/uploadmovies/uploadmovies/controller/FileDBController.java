...
import se.bigjohanna.uploadmovies.uploadmovies.model.FileDBResponse;
import se.bigjohanna.uploadmovies.uploadmovies.model.ResponseMessage;
import se.bigjohanna.uploadmovies.uploadmovies.service.FileDBStorageService;
...
public class FileDBController {
    ...
    public ResponseEntity<List<FileDBResponse>> getListFiles() {
        List<FileDBResponse> files = storageService.getAllFiles().map(dbFile -> {
